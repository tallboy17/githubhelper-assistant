...
- **Lazy Toggl MCP** - Simple unofficial MCP server to track time via Toggl API
...
- **mcp_weather** - Get weather information from  API.
...
- **Prefect** - MCP Server for workflow orchestration and ELT/ETL with Prefect Server, and Prefect Cloud [ using the `prefect` python client.
